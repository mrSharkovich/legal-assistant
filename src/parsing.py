...
def text_extract(pdf_path):
    try:
        ...
        # Если дошли сюда - все методы не сработали
        return ["Ошибка при обработке файла"]

    except Exception as e:
        # Любая ошибка на верхнем уровне
        return ["Ошибка при обработке файла"]

# pdf_path = 'C:/Users/mr.Sharkovich/Desktop/file_check/1.pdf'
# print(text_extract(pdf_path))